						...
						<div class="flex items-end w-10">
									...
									<div class=" flex items-center mb-1">
										<Tooltip content={$i18n.t('Send message')}>
											<button
												...
												class="{prompt !== ''
													? 'bg-gradient-to-r from-[#0c60f4] to-[#5813f3] text-white hover:opacity-80 dark:bg-white dark:text-black dark:hover:bg-gray-100 '
							...
							{:else}
								<div class=" flex items-center mb-1.5">
									<button
										class="bg-gradient-to-r from-[#0c60f4] to-[#5813f3] hover:opacity-80 text-gray-800 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-800 transition rounded-full p-3"
										on:click={() => {
											stopResponse();
										}}
									>
										<svg class="size-3" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" id="mx_n_1719820369895" width="200" height="200"><path d="M830.464 63.488q26.624 0 50.176 12.288t41.472 31.232 28.672 43.008 10.752 46.592l0 635.904q0 23.552-11.264 46.592t-30.208 41.472-43.008 30.208-48.64 11.776l-641.024 0q-22.528 0-44.544-10.752t-39.424-28.16-28.16-40.96-10.752-50.176l0-633.856q0-25.6 10.752-50.176t29.696-43.52 43.52-30.208 52.224-11.264l629.76 0z" fill="#ffffff"></path></svg>
									</button>
								</div>
							{/if}
						</div>
