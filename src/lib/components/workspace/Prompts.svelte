...
<div class=" flex w-full space-x-2">
	...
	<div>
		<a
			...
			href="/llms/workspace/prompts/create"
		>
			<svg
				xmlns="http://www.w3.org/2000/svg"
				viewBox="0 0 16 16"
	...
	{#each $prompts.filter((p) => query === '' || p.command.includes(query)) as prompt}
		...
		>
			<div class=" flex flex-1 space-x-4 cursor-pointer w-full">
				<a href={`/llms/workspace/prompts/edit?command=${encodeURIComponent(prompt.command)}`}>
			...
			<div class="flex flex-row space-x-1 self-center">
				<a
					...
					type="button"
					href={`/llms/workspace/prompts/edit?command=${encodeURIComponent(prompt.command)}`}
				>
					<svg
						xmlns="http://www.w3.org/2000/svg"
						fill="none"
				...
				<button
					...
					on:click={() => {
						...
						goto('/llms/workspace/prompts/create');
					}}
				>
					<svg
						xmlns="http://www.w3.org/2000/svg"
